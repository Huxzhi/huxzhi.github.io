import{_ as d,X as s,Y as l,Z as i,$ as e,a1 as r,a2 as n,G as c}from"./framework-c2b0d87a.js";const v={},u=n(`<h1 id="javascript-廖雪峰" tabindex="-1"><a class="header-anchor" href="#javascript-廖雪峰" aria-hidden="true">#</a> JavaScript 廖雪峰</h1><p>目录</p><p>JavaScript简介</p><p>快速入门</p><h2 id="函数" tabindex="-1"><a class="header-anchor" href="#函数" aria-hidden="true">#</a> 函数</h2><p>函数定义和调用</p><p>利用 <code>arguments</code>，你可以获得调用者传入的所有参数。也就是说，即使函数不定义任何参数，还是可以拿到参数的值：</p><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript"><pre class="language-JavaScript"><code>function abs() {
...
obj.getAge(); // 25
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7);function p(m,b){const a=c("ExternalLinkIcon");return s(),l("div",null,[u,i("p",null,[e("我对闭包的理解 "),i("a",o,[e("闭包(Closure)"),r(a)]),e(" ，适用于其他编程语言")]),t])}const h=d(v,[["render",p],["__file","JavaScript 廖雪峰.html.vue"]]);export{h as default};
