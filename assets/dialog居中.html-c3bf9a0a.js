import{_ as n,W as s,X as a,a2 as e}from"./framework-cbb69da9.js";const t={},p=e(`<h2 id="绝对布局" tabindex="-1"><a class="header-anchor" href="#绝对布局" aria-hidden="true">#</a> 绝对布局</h2><p>如果父组件使用相对布局 会出现问题</p><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">.parent</span><span class="token punctuation">{</span>
